...
public class InfoFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        infoViewModel.getAllStars().observe(getViewLifecycleOwner(), currentEvent -> {
            ...
            binding.infoFragmentType.setText("Budget: " + infoViewModel.getNextStarType());
            binding.infoFragmentAmount.setText("Amount of groups" + infoViewModel.getAmount());
        });
        binding.infoFragmentBtn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                StarModel star = new StarModel("INBO03","B");
